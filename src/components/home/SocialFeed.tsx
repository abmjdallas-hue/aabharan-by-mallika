...
import { socialPosts, type SocialPlatform } from '@/data/socialPosts'
              ...
              >
                  ...
                  {post.thumbnail ? (
                    ...
                    <>
                      ...
                      <div className="absolute inset-0 flex flex-col items-center justify-center gap-3 text-gold-200/80">
                        ...
                        <span className="font-serif text-lg tracking-wide">{post.title}</span>
                      </div>
                    </>
                  )}
                ...
                <div className="p-4">
                  ...
                  <a
                    ...
                    aria-label={`View ${meta.label} ${post.type}: ${post.title}`}
